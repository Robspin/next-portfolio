...
export default function Timeline() {
    ...
    return <div className="text-white lg:w-[1024px] overflow-hidden pb-24 pl-8">
        ...
        <span
            ...
            <svg className="w-2.5 h-2.5 text-blue-800 dark:text-blue-300" aria-hidden="true"
                ...
                <time className="block mb-2 text-sm font-normal leading-none text-gray-400 dark:text-gray-500">Released
