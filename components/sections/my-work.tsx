    ...
    return (
        <PageContainer className="translate-x-[-100vw]">
            ...
            <div className="max-lg:flex-col max-lg:flex overflow-scroll flex h-screen">
                <div className="w-screen lg:w-[300px] max-lg:py-6 max-lg:pl-6 max-lg:pr-16 lg:ml-8 lg:py-24 lg:h-full shrink-0 flex lg:flex-col gap-10 overflow-auto items-center">
                    <MinifiedProject />
                    <MinifiedProject />
                    <MinifiedProject />
                    <MinifiedProject />
                ...
                <div className="max-lg:mx-6 py-6 lg:py-24 lg:mr-24 lg:h-screen lg:overflow-auto">
                    <div className="bg-green-300 opacity-70 rounded">
