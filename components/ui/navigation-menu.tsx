...
const navigationMenuTriggerStyle = cva(
  "group inline-flex h-10 w-max items-center justify-center rounded-md bg-white px-4 max-[404px]:p-0 py-2 text-sm font-medium transition-colors hover:text-neutral-900 focus:outline-none disabled:pointer-events-none disabled:opacity-50 data-[state=open]:bg-neutral-100/50 dark:bg-black dark:hover:text-neutral-50 dark:data-[state=open]:bg-transparent"
)
