export default function Bio() {
    return (
            <div className="h-full bg-green-300 opacity-80 rounded border border-red-400 md:ml-7">
                <div className="p-8 text-lg">
                    <p>
                        ...
                        - Leading the creation of the new Tracefy app along with two external developers<br/>
